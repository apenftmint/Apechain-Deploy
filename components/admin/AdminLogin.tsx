...
const AdminLogin: React.FC<AdminLoginProps> = ({ onLoginSuccess }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-200px)] p-4 bg-slate-800/50 backdrop-blur-sm mt-8 rounded-lg shadow-xl mx-auto max-w-md w-full">
      <h2 className="text-3xl font-bold text-sky-400 mb-8">Admin Login</h2>
      ...
      <form onSubmit={handleSubmit} className="w-full space-y-6">
       ...
       <a href="#/" className="mt-6 text-sm text-slate-400 hover:text-sky-300 transition-colors">
